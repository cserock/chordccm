...
@interface PlayDetailViewController : UIViewController <UIScrollViewDelegate>
...
@property (nonatomic, assign) int bookmarkIndex;
...
@property (nonatomic, assign) int songInfoId;
