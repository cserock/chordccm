...
- (void)makeToastActivity:(id)position {
    ...
    activityView.backgroundColor = [[UIColor colorWithRed:79.0f/255.0f
                                                    green:80.0f/255.0f
                                                     blue:82.0f/255.0f
                                                    alpha:1.0f] colorWithAlphaComponent:CSToastOpacity];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[UIColor colorWithRed:79.0f/255.0f
                                                   green:80.0f/255.0f
                                                    blue:82.0f/255.0f
                                                   alpha:1.0f] colorWithAlphaComponent:CSToastOpacity];
